/**
 * `safeDisconnect` moved to `ui/lib/nidara-kit/platform/signals.ts` (2026-08-15) so the kit could use it:
 ...
 * `ui/lib/nidara-kit/platform/signals.ts`.
 */
export { safeDisconnect } from "../../lib/nidara-kit/platform/signals"
