export default {
    ...
    "settings.appearance.gtk-theme.desc": "Look of GTK apps that aren't Nidara's",
    "settings.appearance.cursor.desc": "Cursor style",
    "settings.appearance.icons.desc": "Applications, the dock and the app grid",
    ...
    "settings.appearance.icons": "App icons",
    "settings.appearance.interface-icons": "Interface icons",
    "settings.appearance.interface-icons.desc": "The bar, menus and Settings",
    ...
    "settings.appearance.gtk-theme": "External app theme",
    ...
    "settings.network.ap.other": "Other network…",
