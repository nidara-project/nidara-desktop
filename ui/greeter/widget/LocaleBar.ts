...
import { ndImageProps } from "../../lib/nidara-kit/platform/icons"
import { withGlassCapsule } from "../../lib/nidara-kit/platform/glass-capsule"
...
export default function LocaleBar(): Gtk.Widget {
  ...
  const kbIcon = new Gtk.Image(ndImageProps("nd-input-keyboard", "input-keyboard-symbolic", 12))
