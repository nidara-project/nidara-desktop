export default {
    ...
    "settings.appearance.row.label.night-light-schedule": "Activate automatically",
    "settings.appearance.row.desc.night-light-schedule": "Turn Night Light on and off on a schedule",
    "settings.appearance.row.label.night-light-from": "Turn on at",
    "settings.appearance.row.label.night-light-to": "Turn off at",
    ...
    "settings.appearance.row.label.shell-opacity": "Shell Glass",
    "settings.appearance.row.desc.shell-opacity": "Opacity of the bar, panels and overlays",
    "settings.appearance.row.label.dock-opacity": "Dock Glass",
    "settings.appearance.row.desc.dock-opacity": "Opacity of the dock surface",
    "settings.appearance.row.label.transparencia-profunda": "Window Transparency",
    ...
    "settings.appearance.row.label.text-scaling": "Text Scaling",
    "settings.appearance.row.desc.text-scaling": "Scale factor applied to all text system-wide",
    ...
    "settings.apps.page.title.aplicaciones": "App Icons",
    ...
    "settings.notif.row.label.timeout": "Auto-dismiss After",
    "settings.notif.row.desc.timeout": "How long a popup stays on screen before hiding",
    "settings.notif.group.dnd": "Do Not Disturb",
    "settings.notif.row.label.dnd-default": "Enable on Login",
    "settings.notif.row.desc.dnd-default": "Start each session with Do Not Disturb active",
    ...
    "settings.bar.row.label.system-menu": "System Menu",
    "settings.bar.row.desc.system-menu": "Show the distro icon and system menu button",
    "settings.bar.row.label.app-title": "Active App Title",
