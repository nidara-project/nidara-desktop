...
| `NightLightManager.ts` | 174 | Blue-light filter via hyprsunset (GSettings `org.nidara.night-light`). |
...
a daemon, pushing to the compositor, firing a user hook — must only be wired in the shell. Today the
