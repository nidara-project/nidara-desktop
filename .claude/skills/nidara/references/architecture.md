...
| Astal system services | **None — 100% eliminated.** All services (Network, Battery, Bluetooth, Hyprland, MPRIS, Apps, WirePlumber, Notifd, Tray, Greet) are native TypeScript, and PAM authentication is native C (`lib/nidara-auth/`, `gi://NidaraAuth`). |
