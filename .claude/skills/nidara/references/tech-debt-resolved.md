...
### 100. ✅ RESOLVED 2026-09-15 (#581, closes #305) — the shell grew 460 MB over 21 hours, and it was undisposed Cairo contexts (2026-08-30)
...
through `cairoDraw`, every `append_cairo` is disposed — CI enforces both. Still open, and separate:
the dock animation costs ~40 % of a core while it runs. The history below is kept because the
