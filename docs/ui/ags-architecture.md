...
Crystal Shell utiliza la versión moderna de AGS (v3+), basada en el ecosistema **Astal**. Esta versión es superior para el manejo de desenfoques (blur) en Ubuntu 24.04.
...
## 2. Estructura del Proyecto (Crystal Shell)
```text
~/.config/crystal-shell/ui/ags-v3/
...
## 3. Principios de Crystal Shell (v3)
