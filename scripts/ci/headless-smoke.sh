...
phase_deps() {
    ...
    # lib/hyprland and lib/mpris are absent on purpose; booting the shell here is
    # what proves they are not needed — and for hyprland that is a real test, since
    # the smoke boots a compositor and the shell has to model it.
    local astal_subdirs=(
