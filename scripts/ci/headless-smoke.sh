...
phase_deps() {
    ...
    # ("Settings schema 'io.astal.notifd' is not installed"). That schema was
    # libastal-notifd's, and it was the ONLY one in the whole pinned stack — the
    # call stays as the guard for the next dependency that ships one, since the
    # failure mode is an abort with a message about a schema nobody added.
    finish_install() {
