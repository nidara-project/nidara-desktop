...
// (SKIN=dark|light lived here until 2026-09-21. The login screens had two palettes and
// chose between them by measuring the wallpaper; the owner removed the mechanism — see
// #613 — so there is one palette, white ink over dark glass, and nothing left to
// choose. BG is still yours to set: that is how a wallpaper's effect on legibility is
// looked at now.)
...
if (PAINTER) {
    ...
    print("[warn] no PAINTER — the capsule bodies will not be in the render")
}
